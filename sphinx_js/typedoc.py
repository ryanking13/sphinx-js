...
class Converter:
    def __init__(self, base_dir: str):
        ...
        self.index: dict[int, pyd.IndexType] = {}

    def populate_index(
        self,
        node: pyd.IndexType,
        parent: pyd.IndexType | None = None,
    ) -> "Converter":
        ...
        children: list[Sequence[pyd.IndexType]] = []
    ...
    def convert_all_nodes(self, root: pyd.Root) -> list[TopLevel]:
